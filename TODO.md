...
- [ ] Make the fields part of the filter builder dynamic instead of the static list being used now. The functionality of the existing custom fields like "AI Summary", etc should remain as is.
...
- [ ] In the onboarding e-mail invite, also add a link to ve-mailer GUI endpoint so that people can signup from there. This means that the frontend URL should be stored in the app.props of the spring boot backend.
- [ ] As an user, I should be able to create, manage and subscribe to my own filters, which stay private to me.
