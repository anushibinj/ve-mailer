...
- [ ] As an user, I should be able to create, manage and subscribe to my own filters, which stay private to me. I should be able to see admin-created filters but I should not be able to edit them (although I can preview the filter results)
