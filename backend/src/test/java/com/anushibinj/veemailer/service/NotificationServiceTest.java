...
class NotificationServiceTest {
    ...
    void testBuildHtmlTable_MissingFieldRendersEmptyCell() {
        ...
        assertTrue(html.contains("<td style=\"padding:10px 12px;font-size:13px;color:#1e293b;border:1px solid #e2e8f0;\"></td>"),
    ...
    void testBuildHtmlTable_AiSummaryRespectsSelectedColumnOrder() {
        ...
        int idHeaderIndex = html.indexOf("<th style=\"padding:10px 12px;text-align:left;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;color:#64748b;border:1px solid #e2e8f0;\">Id</th>");
        int aiHeaderIndex = html.indexOf("<th style=\"padding:10px 12px;text-align:left;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;color:#64748b;border:1px solid #e2e8f0;\">AI Summary</th>");
        int phaseHeaderIndex = html.indexOf("<th style=\"padding:10px 12px;text-align:left;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;color:#64748b;border:1px solid #e2e8f0;\">Phase</th>");
