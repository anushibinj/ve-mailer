...
1. **Easy Filter Builder** (recommended) — a visual, non-technical UI where:
   ...
   - The **Fields to Fetch** list is loaded dynamically from the same metadata for the selected entity type (instead of a static frontend list), while keeping custom pseudo-fields like **✨ AI Summary** and **Triage SLA**
